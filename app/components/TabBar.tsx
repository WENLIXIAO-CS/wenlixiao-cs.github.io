        ...
        <button
          ...
          className={`px-4 py-2 rounded-full transition-all text-sm font-medium ${
            activeKey === tab.key
              ...
              : 'bg-[#f4f1ea]/85 dark:bg-white/[0.06] backdrop-blur-sm border border-white/50 dark:border-white/[0.08] text-[#6b7a8d] dark:text-white/40 hover:bg-[#fbf9f4]/90 dark:hover:bg-white/10'
          }`}
        >
          {tab.label}
        </button>
